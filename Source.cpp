...
int main()
{
    ...
    Registered_User* reg_user1 = new Registered_User("Devanja", 1, "vali@gamil.com", "04/07/2000", "Female", "No21 valivita rd,malabe", "null");
    reg_user1->giveFeedback(fdb1);
    reg_user1->displayDetails();
    reg_user1 -> ~Registered_User();

    Registered_User* reg_user2 = new Registered_User("Bandara", 1, "devkaluR@gamil.com", "21/07/2000", "Male", "No88 vihara rd,malabe", "null");
